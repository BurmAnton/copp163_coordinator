        ...
        if 'add-event' in request.POST:
            ...
            if photo_link == "":
                ...
                for quota_event in quota_events:
                    ...
                    quota_event.quota.completed_quota = QuotaEvent.objects.filter(quota=quota_events, event=event).aggregate(completed_quota=Sum("completed_quota"))['completed_quota']
