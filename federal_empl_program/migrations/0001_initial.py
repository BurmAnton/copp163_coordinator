# Generated by Django 3.2.5 on 2021-07-29 06:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('convenient_study_periods', models.CharField(blank=True, choices=[('MRNG', '09.00-13.00'), ('DAYT', '13.00-17.00'), ('EVNG', '17.00-21.00')], default='--empty--', max_length=4, null=True, verbose_name='Удобное время занятий')),
                ('purpose', models.CharField(blank=True, choices=[('SWRK', 'Самозанятость, предпринимательство'), ('WORK', 'Сохранение работы'), ('WRKS', 'Поиск новой работы'), ('SDEV', 'Саморазвитие')], default='--empty--', max_length=4, null=True, verbose_name='Цель')),
                ('need_consultation', models.BooleanField(default=False, verbose_name='Нужна ли консультация по самозаятости')),
                ('pref_contract_type', models.CharField(blank=True, choices=[('OLD', 'Трехсторонний договор со старым работодателем'), ('NEW', 'Трехсторонний договор с новым работодателем'), ('SELF', 'Двухсторонный договор')], default='--empty--', max_length=4, null=True, verbose_name='Предпочитаемый тип контракта')),
            ],
            options={
                'verbose_name': 'Анкета',
